...
Translates between file formats and generates static code.
  ...
  -o, --out        Saves to a file instead of post to stdout.
...
Note that as of this post, the benchmark suite performs significantly slower on node 7.2.0 compared to 6.9.1 because moths.
